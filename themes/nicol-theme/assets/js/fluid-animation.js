...
function fluid_init() {
    ...
    let fluid_bg = canvas.getAttribute('data-fluid-bg') ? canvas.getAttribute('data-fluid-bg') : "#02030F",
    ...
    document.querySelector('.css_prefix').addEventListener('mousemove', e => {
    ...
    var boom = document.querySelector(".css_prefix-boom");
    if (boom !== null) {
